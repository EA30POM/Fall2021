...
**Readings**: This course will use a combination of the primary literature, popular science books, and the textbook *Living in the Environment* (LITE for short). Please note that you **do not need to purchase** *Living in the Environment* -- all readings will be available online.
