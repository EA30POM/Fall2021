...
It is **not necessary** to perform a statistical analysis of the data to answer your question. However, some groups have questions that are amenable to statistical analysis based on tests we have already learned about in this class. If that is the case for your group, I have included my suggestion there.
