...
The code below is how I have wrangled these data to clean them up. I am building an app though that will take the URL of your sheet and automagically push a clean sheet to a new tab called `"clean"`. The [app will be here](https://chchang47.shinyapps.io/EA30PLair/).
...
airDF <- googlesheets4::read_sheet(gs_url)
...
### FMI: ?source
source("https://raw.githubusercontent.com/EA30POM/Fall2021/main/helpers/CleanPLiOS.R")

### Using a helper function to clean up our iOS Air Data
airCleanDF <- cleanup_air_function(airDF)
...
### computer use it.
readr::write_csv(airCleanDF,path="~/PLAirDataClean.csv")
```
